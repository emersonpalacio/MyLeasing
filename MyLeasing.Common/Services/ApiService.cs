...
namespace MyLeasing.Common.Services
{
    public class ApiService : IApiService
    {
        ...
        public async Task<Response<TokenResponse>> GetTokenAsync(
             ...
             TokenRequest request)  // convinacion de usuario y contraseña
        {
            try
            {
                ...
                var url = $"{ap}{servicePrefix}{controller}";
        ...
        public async Task<Response<object>> ChangePasswordAsync(string urlBase,
                                                                  string servicePrefix,
                                                                  string controller,
        ...
        public async Task<Response<object>> GetListAsync<T>( string urlBase,
                                                            string servicePrefix,
                                                            string controller,
                                                            string tokenType,
                                                            string accessToken)
